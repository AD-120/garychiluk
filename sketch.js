...
function setup() {
  ...
  newGameButton = createButton("בוא לחלק עם גארי ילדון");
...
function generateQuestion() {
  num2 = int(random(2, 11)); // Divisor should be between 2 and 10
  num1 = num2 * int(random(2, 11)); // Dividend should be a multiple of the divisor
}
...
function checkAnswer() {
  ...
  if (userAnswer === num1 / num2) {
    ...
    message.html(`טעית! גארי יחלק אותך <br> התשובה היא ${correctAnswer}`);
